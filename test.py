...
class TestPromotion(unittest.TestCase):
    ...
    #     print('Test: 3 for 2 promotion on atv - consider 3 atv')
    #     co = Checkout()
    #     co.scan('atv')
    #     co.scan('atv')
    #     co.scan('atv')
    ...
    def test_rule_ipad4(self):
        print('Test: ipad>4 discount to 499.99 each - consider 5 ipd')
        co = Checkout()
        co.scan('ipd')
        co.scan('ipd')
        co.scan('ipd')
    ...
    #     co = Checkout()
    #     print('Test: vga free paired with every mbp - consider 2 vga and 3 mbp')
    #     co.scan('vga')
    #     co.scan('vga')
    #     co.scan('mbp')
    #     co.scan('mbp')
